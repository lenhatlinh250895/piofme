        ...
        <div class="modal-content">
            ...
            <form id="formedit" class="formCreate" enctype="multipart/form-data">
                ...
                <div class="col-md-12 col-lg-6">
                    ...
                    <label>Title</label>
                    <input class="form-control inp-name" name="title" type="text " value="" id="example-text-input"
                        placeholder="Title">
                    </div>
                </div>
                <div class="col-md-12 col-lg-6 ">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6"><input id="thumbnail" name="image" value="" class="form-control" type="text"></div>
                            <div class="col-md-6"><input name="alt_image" value="" class="form-control" type="text" placeholder="Alt image"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-6 ">
                    ...
                    <label for="example-text-input" class="col-sm-2 col-form-label">Introduce</label>
                    <div class="col-sm-12">
                        <textarea class="summernote-editor" name="introduce"></textarea>
                    </div>
                </div>
                <div class="col-md-12">
