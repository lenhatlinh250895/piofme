						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="input-group mt-2">
                                    ...
                                    <div class="row">
                                        <div class="md-6"><input id="thumbnail" name="image" class="form-control" type="text"></div>
                                        <div class="md-6"><input name="alt_image" class="form-control" type="text" placeholder="Alt image"></div>
                                    </div>
								</div>
							</div>
						</div>
