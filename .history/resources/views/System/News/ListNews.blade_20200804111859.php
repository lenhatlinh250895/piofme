...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="la->id" data-toggle="tab" href="#$la->slug" role="tab" aria-controls="home" aria-selected="true">ADD NEWS</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="la->id" data-toggle="tab" href="#$la->slug" role="tab" aria-controls="home" aria-selected="true">{{$la->name}}</a>
        </li>
    </ul>
    <div class="row">
		<div class="col-12">
