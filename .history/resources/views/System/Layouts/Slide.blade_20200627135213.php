<div class="sidebar-inner slimscrollleft" id="sidebar-main">
    ...
    <div id="sidebar-menu">
        <ul>
            ...
            <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect waves-light"><i class="fa fa-user"></i><span> {{ __('message.Người Quản Trị') }} </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.admin.user.getListUser') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        {{ __('message.Danh Sách Người Dùng') }}</a></li>
            ...
            @endif   
            <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-bars"></i><span> {{ __('message.Danh Mục') }} </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.admin.category.getListCategory') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        {{ __('message.Danh Sách Danh Mục') }}</a></li>
