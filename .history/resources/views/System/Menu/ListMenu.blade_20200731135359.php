    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('message.Sửa Menu') }}</h4>
            </div>
        </div>
    </div>
                ...
                <div class="element-box">
                    <div class="card card-default">
                        <div class="card-header">
                            <h5 class="card-title text-uppercase mb-0" id="04e5b39b-8301-b53a-ce1b-17f163b8754e">
                                {{ __('message.Danh Mục') }}
                            </h5>
                        </div>
                        <div id="category" class="panel-collapse card-body pt-0 pb-0">
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" data-category_id="{{$cat->id}}" name="categories[]"
                                                value="{{$cat->id}}">
                                            {{$cat->name}}
                                        </label>
                                    </div>
                                </li>
                                @if(count($cat->categories_child))
                                <ul class="list-unstyled" style="padding-left: 25px">
                                    @foreach($cat->categories_child as $child)
                                    <li>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" data-category_id="{{$child->id}}" id="category"
                        ...
                        <div class="form-buttons-w p-3">
                            <a href="javascript:addItemMenu('category');" data-action="category"
                                class="click-edit-menu btn btn-primary">{{ __('message.Add') }} Menu</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-12 col-lg-4 menu-d">
            <div class="element-wrapper">
                <div class="element-box">
                    <div class="card card-default">
                        <div class="card-header">
                            <h5 class="panel-title mb-0 text-uppercase" id="04e5b39b-8301-b53a-ce1b-17f163b8754e">
                                {{ __('message.Tin Tức') }}
                            </h5>
                        </div>
                        <div id="news" class="panel-collapse card-body pt-0 pb-0">
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" data-news_id="{{$n->id}}" name="news[]"
                                                value="{{$n->id}}">
                                            {{$n->title}}
                                        </label>
                                    </div>
                        ...
                        <div class="form-buttons-w p-3">
                            <a href="javascript:void(0);"data-action="news"
                                class="click-edit-menu btn btn-primary">{{ __('message.Add') }} Menu</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="nested-list dd card " id="nestable" style="width:100%;max-width: 420px;">
                        <div class="card-header">
                            <h5 class="card-title" id="04e5b39b-8301-b53a-ce1b-17f163b8754e">
                                Menu
                            </h5>
                        </div>
		                ...
		                <div class="col-md-12 p-0">
		                    <div class="form-buttons-w p-3">
		                        <button id="btn-submit" class="test btn btn-primary" value="">{{ __('message.update') }}</button>
		                    </div>
