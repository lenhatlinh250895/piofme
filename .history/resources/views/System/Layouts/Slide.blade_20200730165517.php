        ...
        <ul>
            ...
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.user.getListUser') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        LIST USER</a></li>
                </ul>
            </li>
            @endif   
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.service.getListService') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        LIST SERVICE</a></li>
                </ul>
            </li>
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.product.getListProduct') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        LIST PRODUCT</a></li>
            ...
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.news.getListNews') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        LIST NEWS</a></li>
                </ul>
            </li>
            <li class="has_sub">
