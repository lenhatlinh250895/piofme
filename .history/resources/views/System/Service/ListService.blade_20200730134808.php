                            ...
                            <tbody>
                                ...
                                <tr id="id_{{$item->id}}">
                                    ...
                                    <div class="btn-group btn-group-sm" style="float: none;">
                                        <a href="{{ Route('system.service.getEditService') }}"><button type="button" data-toggle="modal" data-target="#modalEditUser" data-id="{{$item->id}}" class="btn-edit tabledit-edit-button btn btn-sm btn-light" style="float: none; margin: 5px;"><span class="ti-pencil"></span></button></a>
