...
@endsection
@section('modal')
<div class="modal fade bs-example-modal-lg" id="modalEditUser" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <form id="formedit" class="formCreate" enctype="multipart/form-data">
                ...
                <div class="col-md-12 col-lg-6">
                    ...
                    <label>Title</label>
                    <input class="inp-title form-control inp-name" name="title" type="text " value="" id="example-text-input"
                        placeholder="Title">
                    </div>
                </div>
                <div class="col-md-12 col-lg-6 ">
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6"><input id="thumbnail" name="image" value="" class="form-control inp-image" type="text"></div>
                            <div class="col-md-6"><input name="alt_image" value="" class="form-control inp-alt-image" type="text" placeholder="Alt image"></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-12 col-lg-12 ">
                    ...
                    <label for="example-text-input" class="col-sm-2 col-form-label">Introduce</label>
                    <div class="col-sm-12">
                        <textarea class="summernote-editor text-introduce" name="introduce"></textarea>
                    </div>
                </div>
                <div class="col-md-12">
...
<script>
    ...
    $('.btn-edit').on('click', function(){
        ...
        $.ajax({
            type: 'POST',
            url: "{{ route('system.service.postAjaxService')}}",
            data: {_token: token, id: id},
            dataType: 'JSON',
            success: function($result){
                $('.inp-title').val($result['title']);
                $('.inp-image').val($result['image']);
                $('.inp-alt-image').val($result['alt']);
                $('.text-introduce').html($result['introduce'])
            },
        });
    })
