...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" id="la->id" data-toggle="tab" href="#add-new" role="tab" aria-controls="home" aria-selected="true">ADD NEWS</a>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade in" id="add-new" role="tabpanel" aria-labelledby="1-tab">
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <form action="" method="get"  enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                                    <div class="col-sm-10">
                                        <input name="name_search" value="{{request()->input('name_search')}}" class="form-control" type="text" id="example-text-input" require>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Id</label>
                                    <div class="col-sm-10">
                                        <input name="id_search" value="{{request()->input('id_search')}}" class="form-control" type="text" id="example-text-input" require>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
