        ...
        <ul>
            ...
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.user.getListUser') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST USER</a></li>
                </ul>
            </li>
            @endif   
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.service.getListService') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST SERVICE</a></li>
                </ul>
            </li>
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.product.getListProduct') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST PRODUCT</a></li>
                </ul>
            </li>
            @if(Auth::user()->level != 0)
            <li class="">
            ...
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.quote.getListQuote') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST QUOTE</a></li>
                </ul>
            </li>
            <li class="has_sub">
                <a href="javascript:void(0);" class="waves-effect waves-light"><i class="fa fa-user"></i><span> INF QUOTE </span> <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.information_quote.getListInformationQuote') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST INF QUOTE</a></li>
                </ul>
            </li>
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.news.getListNews') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST NEWS</a></li>
                </ul>
            </li>
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.admin.menu.getListMenu') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST CONTACT</a></li>
                </ul>
            </li>
            <li class="has_sub">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('system.admin.menu.getListMenu') }}"><i class="fa fa-long-arrow-right" aria-hidden="true"></i>LIST MENU</a></li>
                </ul>
            </li>
            @endif 
            <li class="">
                <a href="{{asset('')}}laravel-filemanager?type=image" target="_blank" class="waves-effect waves-light"><i class="fa fa-picture-o"></i><span> IMAGES </span> </a>
            </li>
        </ul>
    </div>
