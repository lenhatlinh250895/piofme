                        ...
                        <table class="table" id="my-table">
                            ...
                            <tbody>
                                ...
                                <div class="btn-group btn-group-sm" style="float: none;">
                                    <button type="button" data-id="{{$item->id}}" class="btn-edit tabledit-edit-button btn btn-sm btn-light" style="float: none; margin: 5px;"><span class="ti-pencil"></span></button>
        ...
        <form method="POST" class="formCreate" enctype="multipart/form-data">
            ...
            <div class="col-md-12 col-lg-6 ">
                ...
                <input class="form-control" name="passwordconfirm" type="password " value="" id="example-text-input"
                    placeholder="Product Key Word">
                </div>
            </div>
            <div class="col-md-12 col-lg-6">
                <div class="form-group">
                <label>Level</label>
                    <select class="form-control" name="productTypeChild" data-live-search="true">
