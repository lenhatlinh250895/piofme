    ...
    <div class="row">
		<div class="col-12">
			<div class="card m-b-30">
				...
				<div class="card-body">
					<form action="{{ route('system.news.postEditNews') }}" method="post"  enctype="multipart/form-data">
						@csrf
                        <input type="hidden" name="id" value="{{$news->id}}">
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Name</label>
                            <div class="col-sm-10">
                                <input name="name" value="{{$news->name}}" class="form-control" type="text" id="example-text-input" require>
                            </div>
                        </div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="input-group mt-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"><input id="thumbnail" name="image" value="{{$news->image}}" class="form-control" type="text"></div>
                                        <div class="col-md-6"><input name="alt_image" value="{{$news->alt}}" class="form-control" type="text" placeholder="Alt image"></div>
                                    </div>
								</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <textarea class="summernote-editor" name="content">{!!$news->content!!}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Summary Content</label>
                            <div class="col-sm-10">
                            <textarea name="summary_content" rows="10" cols="50">{!!$news->summary_content!!}</textarea>
                            </div>
                        </div>
						<div class="form-group row">
							<div class="col-sm-10">
...
<script>
	...
	function cancel(){
		location.replace("{{asset('')}}system/news/list");
	}
</script>
@endsection