				...
				<div class="card-body">
					<form action="{{ route('system.service.postAddService') }}" method="post"  enctype="multipart/form-data">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="input-group mt-2">
									...
									<input id="thumbnail" name="image" class="form-control" type="text">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                            <textarea id="my-editor" name="introduce" class="form-control">{!! old('introduce', 'test editor content') !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
