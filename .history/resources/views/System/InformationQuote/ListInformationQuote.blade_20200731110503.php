    ...
    <div class="row">
		<div class="col-12">
			<div class="card m-b-30">
				...
				<div class="card-body">
					<form action="{{ route('system.information_quote.postAddInformationQuote') }}" method="post"  enctype="multipart/form-data">
						@csrf
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input name="phone_number" value="{!!old('phone_number')!!}" class="form-control" type="number" id="example-text-input" require>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="example-text-input" class="col-sm-2 col-form-label">Email</label>
                            <div class="col-sm-10">
                                <input name="email" value="{!!old('email')!!}" class="form-control" type="email" id="example-text-input" require>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="quote">
                                    ...
                                    <option value="{{$quo->id}}">{{$quo->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <table class="table" id="my-table">
                            ...
                            <tbody>
                                ...
                                <tr id="id_{{$item->id}}">
                                    ...
                                    <td class="tabledit-view-mode"><span class="tabledit-span">{{ $item->quote_id }}</span></td>
