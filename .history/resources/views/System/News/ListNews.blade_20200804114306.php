...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" id="search" data-toggle="tab" href="#search" role="tab" aria-controls="home" aria-selected="true">SEARCH</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" id="add-new" data-toggle="tab" href="#add-new" role="tab" aria-controls="home" aria-selected="true">ADD NEWS</a>
        </li>
    </ul>
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show in" id="add-new" role="tabpanel" aria-labelledby="1-tab">
            <div class="row">
                <div class="col-12">
        ...
        <div class="tab-pane fade in active" id="search" role="tabpanel" aria-labelledby="2-tab">
            <div class="row">
                <div class="col-12">
                    <div class="card m-b-30">
                        <div class="card-body">
                            <form action="" method="get"  enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="id" value="{!!old('id')!!}" class="form-control" type="text" id="example-text-input" require>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-10">
