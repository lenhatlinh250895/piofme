...
<html lang="en">
    <head>
        ...
        <title>@yield('title') | PIOFME</title>
        <meta content="PIOFME" name="description" />
        <meta content="PIOFME" name="author" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
		...
		<style>
            ...
            html::-webkit-scrollbar-track {
                -webkit-box-shadow: inset 0 0 6px rgb(152, 27, 31, .9);
            ...
            html::-webkit-scrollbar-thumb {
                background-color: rgb(152, 27, 31, .9);
            }
            .slimScrollBar{
                max-width: 7px;
            }
            ...
            <div class="left side-menu">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        ...
                        <a href="index.html" class="logo"><img src="" height="50" alt="logo"></a>
                    </div>
                </div>
               

                 @include('System.Layouts.Slide')
                 <!-- end sidebarinner -->
            </div>
            <!-- Left Sidebar End -->
