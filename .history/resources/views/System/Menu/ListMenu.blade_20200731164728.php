                    ...
                    <div class="nested-list dd card " id="nestable" style="width:100%;max-width: 420px;">
	                        ...
	                        <ol class="testne dd-list div-move">
	                            ...
	                            <li class="dd-item" data-id="{{$item->id}}" data-name="{{$item->name}}"
	                                ...
	                                <div class="dd-handle" style="padding-right: 5px">
                                        {{$item->name}}
                                        <button data-id="{{$item->id}}" class="pull-right no-border btn btn-xs"><i class="fa fa-times"></i></button>
                                    </div>
	                                ...
	                                <ol class="dd-list">
	                                    ...
	                                    <li class="dd-item"
	                                        ...
	                                        <div class="dd-handle" style="padding-right: 5px">
		                                        {{$child->name}}
												<button data-id="{{$child->id}}" class="pull-right no-border btn btn-xs"><i class="fa fa-times"></i></button>
		                                    </div>
		                ...
		                <div class="col-md-12 p-0">
		                    ...
		                    <li class="dd-item dd-item-clone d-none" data-name="" data-id=""
		                        data-service_id="" data-product_id="">
		                        <div class="item-wrap dd-handle" style="padding-right: 5px">
                                    <span class="item-name"></span>
                                    <button data-id="" class="button-remove pull-right no-border btn btn-xs"><i class="fa fa-times"></i></button>
                                </div>
		                    </li>
		                </div>
                    </div>
...
<script type="text/javascript">
    ...
    function addItemMenu(type) {
        $('#'+type+' .checkbox input:checked').each(function () {
            ...
            itemClone.find('.item-wrap .button-remove').attr('data-id', id_location+1);
