                    ...
                    <form method="POST" class="formCreate" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input value="{{ $user->name }}" name="name" class="form-control" type="text" id="example-text-input" placeholder="Enter name user">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label">{{ __('message.Email') }}</label>
                                <div class="col-sm-10">
                                    <input value="{{ $user->email }}" name="email" readonly class="form-control" type="email" id="example-text-input" placeholder="Enter email user">
                                </div>
                            </div>
                            <div class="form-group row">
